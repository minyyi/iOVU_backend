...
public class Dashboard {
    ...
    public Dashboard(Integer report_id, Integer result_summary, double brand_rate1, Integer brand_rate2, Integer brand_rank, double domain_rate1, Integer domain_rate2, Integer brand_mention) {
